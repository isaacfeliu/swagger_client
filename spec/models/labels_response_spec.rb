...
# Unit tests for SwaggerClient::LabelsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::LabelsResponse.new
  end
  ...
  describe 'test an instance of LabelsResponse' do
    it 'should create an instance of LabelsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::LabelsResponse)
    end
  end
