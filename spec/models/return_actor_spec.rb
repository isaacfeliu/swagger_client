...
# Unit tests for SwaggerClient::ReturnActor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReturnActor' do
  before do
    # run before each test
    @instance = SwaggerClient::ReturnActor.new
  end
  ...
  describe 'test an instance of ReturnActor' do
    it 'should create an instance of ReturnActor' do
      expect(@instance).to be_instance_of(SwaggerClient::ReturnActor)
    end
  end
