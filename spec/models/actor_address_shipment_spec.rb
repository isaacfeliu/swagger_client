...
# Unit tests for SwaggerClient::ActorAddressShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActorAddressShipment' do
  before do
    # run before each test
    @instance = SwaggerClient::ActorAddressShipment.new
  end
  ...
  describe 'test an instance of ActorAddressShipment' do
    it 'should create an instance of ActorAddressShipment' do
      expect(@instance).to be_instance_of(SwaggerClient::ActorAddressShipment)
    end
  end
  ...
  describe 'test attribute "pickup_centre_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
