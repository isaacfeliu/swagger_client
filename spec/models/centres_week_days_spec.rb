...
# Unit tests for SwaggerClient::CentresWeekDays
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CentresWeekDays' do
  before do
    # run before each test
    @instance = SwaggerClient::CentresWeekDays.new
  end
  ...
  describe 'test an instance of CentresWeekDays' do
    it 'should create an instance of CentresWeekDays' do
      expect(@instance).to be_instance_of(SwaggerClient::CentresWeekDays)
    end
  end
