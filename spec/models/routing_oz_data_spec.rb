...
# Unit tests for SwaggerClient::RoutingOZData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoutingOZData' do
  before do
    # run before each test
    @instance = SwaggerClient::RoutingOZData.new
  end
  ...
  describe 'test an instance of RoutingOZData' do
    it 'should create an instance of RoutingOZData' do
      expect(@instance).to be_instance_of(SwaggerClient::RoutingOZData)
    end
  end
  describe 'test attribute "routing_ozs"' do
    it 'should work' do
