...
# Unit tests for SwaggerClient::ErrorRoutingOZInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorRoutingOZInput' do
  before do
    # run before each test
    @instance = SwaggerClient::ErrorRoutingOZInput.new
  end
  ...
  describe 'test an instance of ErrorRoutingOZInput' do
    it 'should create an instance of ErrorRoutingOZInput' do
      expect(@instance).to be_instance_of(SwaggerClient::ErrorRoutingOZInput)
    end
  end
