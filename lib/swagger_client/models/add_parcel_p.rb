...
module SwaggerClient
  class AddParcelP
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parcelReference')
        self.parcel_reference = attributes[:'parcelReference']
      end

      if attributes.has_key?(:'agdReference')
        self.agd_reference = attributes[:'agdReference']
      end
    ...
    def list_invalid_properties
      ...
      if @parcel_reference.nil?
        invalid_properties.push('invalid value for "parcel_reference", parcel_reference cannot be nil.')
      end

      if @agd_reference.nil?
        invalid_properties.push('invalid value for "agd_reference", agd_reference cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @parcel_reference.nil?
      return false if @agd_reference.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          height == o.height &&
          length == o.length &&
          parcel_reference == o.parcel_reference &&
          agd_reference == o.agd_reference &&
          ecb == o.ecb &&
    ...
    def hash
      [weight, width, height, length, parcel_reference, agd_reference, ecb, parcel_number].hash
    end
