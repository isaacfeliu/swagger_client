...
# Unit tests for SwaggerClient::ActorSender
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActorSender' do
  before do
    # run before each test
    @instance = SwaggerClient::ActorSender.new
  end
  ...
  describe 'test an instance of ActorSender' do
    it 'should create an instance of ActorSender' do
      expect(@instance).to be_instance_of(SwaggerClient::ActorSender)
    end
  end
