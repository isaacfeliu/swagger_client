...
# Unit tests for SwaggerClient::CollectionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CollectionResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CollectionResponse.new
  end
  ...
  describe 'test an instance of CollectionResponse' do
    it 'should create an instance of CollectionResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CollectionResponse)
    end
  end
