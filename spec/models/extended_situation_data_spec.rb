...
# Unit tests for SwaggerClient::ExtendedSituationData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExtendedSituationData' do
  before do
    # run before each test
    @instance = SwaggerClient::ExtendedSituationData.new
  end
  ...
  describe 'test an instance of ExtendedSituationData' do
    it 'should create an instance of ExtendedSituationData' do
      expect(@instance).to be_instance_of(SwaggerClient::ExtendedSituationData)
    end
  end
end
