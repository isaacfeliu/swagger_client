...
# Unit tests for SwaggerClient::Custom
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Custom' do
  before do
    # run before each test
    @instance = SwaggerClient::Custom.new
  end
  ...
  describe 'test an instance of Custom' do
    it 'should create an instance of Custom' do
      expect(@instance).to be_instance_of(SwaggerClient::Custom)
    end
  end
  describe 'test attribute "allows_customs"' do
    it 'should work' do
  ...
  describe 'test attribute "shipment_value"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
