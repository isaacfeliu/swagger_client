...
module SwaggerClient
  class ActorReceiver
    ...
    def list_invalid_properties
      ...
      if !@account_number.nil? && @account_number.to_s.length > 10
        invalid_properties.push('invalid value for "account_number", the character length must be smaller than or equal to 10.')
      end
      ...
      if !@id_number.nil? && @id_number.to_s.length > 50
        invalid_properties.push('invalid value for "id_number", the character length must be smaller than or equal to 50.')
      end
    ...
    def valid?
      return false if !@account_number.nil? && @account_number.to_s.length > 10
      return false if @name.nil?
      return false if @name.to_s.length > 50
      return false if !@id_number.nil? && @id_number.to_s.length > 50
    ...
    def account_number=(account_number)
      if !account_number.nil? && account_number.to_s.length > 10
        fail ArgumentError, 'invalid value for "account_number", the character length must be smaller than or equal to 10.'
      end
    ...
    def id_number=(id_number)
      if !id_number.nil? && id_number.to_s.length > 50
        fail ArgumentError, 'invalid value for "id_number", the character length must be smaller than or equal to 50.'
      end
    ...
    def hash
      [account_number, name, id_number, phone, contact_name, email, address].hash
    end
