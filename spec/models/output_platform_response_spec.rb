...
# Unit tests for SwaggerClient::OutputPlatformResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OutputPlatformResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::OutputPlatformResponse.new
  end
  ...
  describe 'test an instance of OutputPlatformResponse' do
    it 'should create an instance of OutputPlatformResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::OutputPlatformResponse)
    end
  end
