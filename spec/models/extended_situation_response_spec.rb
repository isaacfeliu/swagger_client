...
# Unit tests for SwaggerClient::ExtendedSituationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExtendedSituationResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ExtendedSituationResponse.new
  end
  ...
  describe 'test an instance of ExtendedSituationResponse' do
    it 'should create an instance of ExtendedSituationResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ExtendedSituationResponse)
    end
  end
