...
# Unit tests for SwaggerClient::CitiesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CitiesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CitiesResponse.new
  end
  ...
  describe 'test an instance of CitiesResponse' do
    it 'should create an instance of CitiesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CitiesResponse)
    end
  end
