...
# Unit tests for SwaggerClient::ActorAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActorAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::ActorAddress.new
  end
  ...
  describe 'test an instance of ActorAddress' do
    it 'should create an instance of ActorAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::ActorAddress)
    end
  end
