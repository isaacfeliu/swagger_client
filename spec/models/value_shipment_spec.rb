...
# Unit tests for SwaggerClient::ValueShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValueShipment' do
  before do
    # run before each test
    @instance = SwaggerClient::ValueShipment.new
  end
  ...
  describe 'test an instance of ValueShipment' do
    it 'should create an instance of ValueShipment' do
      expect(@instance).to be_instance_of(SwaggerClient::ValueShipment)
    end
  end
