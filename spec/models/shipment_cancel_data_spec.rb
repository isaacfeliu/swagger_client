...
# Unit tests for SwaggerClient::ShipmentCancelData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentCancelData' do
  before do
    # run before each test
    @instance = SwaggerClient::ShipmentCancelData.new
  end
  ...
  describe 'test an instance of ShipmentCancelData' do
    it 'should create an instance of ShipmentCancelData' do
      expect(@instance).to be_instance_of(SwaggerClient::ShipmentCancelData)
    end
  end
  describe 'test attribute "expedition_code"' do
    it 'should work' do
