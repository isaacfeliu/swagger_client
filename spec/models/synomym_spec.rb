...
# Unit tests for SwaggerClient::Synomym
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Synomym' do
  before do
    # run before each test
    @instance = SwaggerClient::Synomym.new
  end
  ...
  describe 'test an instance of Synomym' do
    it 'should create an instance of Synomym' do
      expect(@instance).to be_instance_of(SwaggerClient::Synomym)
    end
  end
  ...
  describe 'test attribute "code_language"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
