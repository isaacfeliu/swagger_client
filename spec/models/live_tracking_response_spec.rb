...
# Unit tests for SwaggerClient::LiveTrackingResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LiveTrackingResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::LiveTrackingResponse.new
  end
  ...
  describe 'test an instance of LiveTrackingResponse' do
    it 'should create an instance of LiveTrackingResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::LiveTrackingResponse)
    end
  end
