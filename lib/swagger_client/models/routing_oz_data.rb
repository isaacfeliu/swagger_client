...
module SwaggerClient
  class RoutingOZData
    ...
    def self.swagger_types
      {
        :'routing_ozs' => :'Array<RoutingOZInput>',
        :'errors' => :'Array<ErrorRoutingOZInput>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'routingOZs')
        if (value = attributes[:'routingOZs']).is_a?(Array)
          self.routing_ozs = value
        end
      end
