...
module SwaggerClient
  class ExtendedSituation
    attr_accessor :ref_type

    attr_accessor :ref

    attr_accessor :shipment_ref
    ...
    def self.swagger_types
      {
        ...
        :'city_name' => :'String',
        :'type' => :'String',
        :'situations' => :'Array<ExtendedSituationSituation>',
        :'refs' => :'ExtendedReference',
        :'packs' => :'Array<ExtendedPack>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shipmentRef')
        self.shipment_ref = attributes[:'shipmentRef']
      end

      if attributes.has_key?(:'collectionRef')
        self.collection_ref = attributes[:'collectionRef']
      end
      ...
      if attributes.has_key?(:'situations')
        if (value = attributes[:'situations']).is_a?(Array)
          self.situations = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ref_type == o.ref_type &&
          ref == o.ref &&
          shipment_ref == o.shipment_ref &&
          collection_ref == o.collection_ref &&
    ...
    def hash
      [ref_type, ref, shipment_ref, collection_ref, business_unit, postal_code, city_name, type, situations, refs, packs].hash
    end
