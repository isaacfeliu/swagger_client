...
# Unit tests for SwaggerClient::PodResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PodResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::PodResponse.new
  end
  ...
  describe 'test an instance of PodResponse' do
    it 'should create an instance of PodResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::PodResponse)
    end
  end
