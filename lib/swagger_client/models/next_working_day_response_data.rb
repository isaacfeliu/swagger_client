...
module SwaggerClient
  class NextWorkingDayResponseData
    attr_accessor :next_working_day
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nextWorkingDay')
        self.next_working_day = attributes[:'nextWorkingDay']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          next_working_day == o.next_working_day
    end
