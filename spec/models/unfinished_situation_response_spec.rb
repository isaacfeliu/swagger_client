...
# Unit tests for SwaggerClient::UnfinishedSituationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnfinishedSituationResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::UnfinishedSituationResponse.new
  end
  ...
  describe 'test an instance of UnfinishedSituationResponse' do
    it 'should create an instance of UnfinishedSituationResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::UnfinishedSituationResponse)
    end
  end
