...
# Unit tests for SwaggerClient::EditResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EditResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::EditResponse.new
  end
  ...
  describe 'test an instance of EditResponse' do
    it 'should create an instance of EditResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::EditResponse)
    end
  end
