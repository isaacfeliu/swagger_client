...
module SwaggerClient
  class EditResponse
    ...
    def list_invalid_properties
      ...
      if @shipment_code.nil?
        invalid_properties.push('invalid value for "shipment_code", shipment_code cannot be nil.')
      end
    ...
    def valid?
      return false if @shipment_code.nil?
