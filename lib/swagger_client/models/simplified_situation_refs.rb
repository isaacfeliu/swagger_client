...
module SwaggerClient
  class SimplifiedSituationRefs
    ...
    # origin agent reference
    attr_accessor :ago

    # destination agent reference
    attr_accessor :agd
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rmt')
        self.rmt = attributes[:'rmt']
      end
      ...
      if attributes.has_key?(:'ord')
        self.ord = attributes[:'ord']
      end

      if attributes.has_key?(:'ago')
        self.ago = attributes[:'ago']
      end

      if attributes.has_key?(:'agd')
        self.agd = attributes[:'agd']
      end

      if attributes.has_key?(:'expId')
        self.exp_id = attributes[:'expId']
      end
    end
    ...
    def hash
      [rmt, dst, ord, ago, agd, exp_id].hash
    end
