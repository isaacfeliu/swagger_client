...
# Unit tests for SwaggerClient::LiveTrackingResponseDto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LiveTrackingResponseDto' do
  before do
    # run before each test
    @instance = SwaggerClient::LiveTrackingResponseDto.new
  end
  ...
  describe 'test an instance of LiveTrackingResponseDto' do
    it 'should create an instance of LiveTrackingResponseDto' do
      expect(@instance).to be_instance_of(SwaggerClient::LiveTrackingResponseDto)
    end
  end
