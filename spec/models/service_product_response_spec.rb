...
# Unit tests for SwaggerClient::ServiceProductResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceProductResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ServiceProductResponse.new
  end
  ...
  describe 'test an instance of ServiceProductResponse' do
    it 'should create an instance of ServiceProductResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ServiceProductResponse)
    end
  end
