...
# Unit tests for SwaggerClient::RoutingOZResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoutingOZResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::RoutingOZResponse.new
  end
  ...
  describe 'test an instance of RoutingOZResponse' do
    it 'should create an instance of RoutingOZResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::RoutingOZResponse)
    end
  end
