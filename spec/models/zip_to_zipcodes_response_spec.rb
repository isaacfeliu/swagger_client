...
# Unit tests for SwaggerClient::ZipToZipcodesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZipToZipcodesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ZipToZipcodesResponse.new
  end
  ...
  describe 'test an instance of ZipToZipcodesResponse' do
    it 'should create an instance of ZipToZipcodesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ZipToZipcodesResponse)
    end
  end
