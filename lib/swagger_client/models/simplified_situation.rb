...
module SwaggerClient
  class SimplifiedSituation
    ...
    # shipmen code
    attr_accessor :shipment_internal_code
    ...
    def self.attribute_map
      {
        ...
        :'ref' => :'ref',
        :'type' => :'type',
        :'shipment_internal_code' => :'shipmentInternalCode',
        :'refs' => :'refs'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'ref' => :'String',
        :'type' => :'String',
        :'shipment_internal_code' => :'String',
        :'refs' => :'SimplifiedSituationRefs'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'refType')
        self.ref_type = attributes[:'refType']
      end
      ...
      if attributes.has_key?(:'shipmentInternalCode')
        self.shipment_internal_code = attributes[:'shipmentInternalCode']
      end
    ...
    def valid?
      ref_type_validator = EnumAttributeValidator.new('String', ['REFERENCE', 'ECB', 'PARCEL_NUMBER', 'SECOND_REFERENCE', 'PACK_REFERENCE'])
    ...
    def ref_type=(ref_type)
      validator = EnumAttributeValidator.new('String', ['REFERENCE', 'ECB', 'PARCEL_NUMBER', 'SECOND_REFERENCE', 'PACK_REFERENCE'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ref == o.ref &&
          type == o.type &&
          shipment_internal_code == o.shipment_internal_code &&
          refs == o.refs
    end
    ...
    def hash
      [event_code, description, situation_date, ref_type, ref, type, shipment_internal_code, refs].hash
    end
