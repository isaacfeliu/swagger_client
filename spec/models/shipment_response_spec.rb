...
# Unit tests for SwaggerClient::ShipmentResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ShipmentResponse.new
  end
  ...
  describe 'test an instance of ShipmentResponse' do
    it 'should create an instance of ShipmentResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ShipmentResponse)
    end
  end
