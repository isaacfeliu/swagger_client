...
# Unit tests for SwaggerClient::ValuateResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValuateResponseBody' do
  before do
    # run before each test
    @instance = SwaggerClient::ValuateResponseBody.new
  end
  ...
  describe 'test an instance of ValuateResponseBody' do
    it 'should create an instance of ValuateResponseBody' do
      expect(@instance).to be_instance_of(SwaggerClient::ValuateResponseBody)
    end
  end
end
