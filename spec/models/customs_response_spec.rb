...
# Unit tests for SwaggerClient::CustomsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CustomsResponse.new
  end
  ...
  describe 'test an instance of CustomsResponse' do
    it 'should create an instance of CustomsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CustomsResponse)
    end
  end
