...
# Unit tests for SwaggerClient::Pod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Pod' do
  before do
    # run before each test
    @instance = SwaggerClient::Pod.new
  end
  ...
  describe 'test an instance of Pod' do
    it 'should create an instance of Pod' do
      expect(@instance).to be_instance_of(SwaggerClient::Pod)
    end
  end
  ...
  describe 'test attribute "pod_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
