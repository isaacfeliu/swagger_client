...
module SwaggerClient
  class PodServicesApi
    ...
    # @option opts [BOOLEAN] :sandbox enables sandbox mode. Example: false (default to false)
    # @option opts [String] :pod_type Pod type. Example: CONTENT | LINK. By default is CONTENT
    # @return [PodResponse]
    def pic_v1_pods_get(authorization, id_number, ref, ref_type, opts = {})
      data, _status_code, _headers = pic_v1_pods_get_with_http_info(authorization, id_number, ref, ref_type, opts)
      data
    end
    ...
    # @option opts [String] :pod_type Pod type. Example: CONTENT | LINK. By default is CONTENT
    # @return [Array<(PodResponse, Fixnum, Hash)>] PodResponse data, response status code and response headers
    def pic_v1_pods_get_with_http_info(authorization, id_number, ref, ref_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PodServicesApi.pic_v1_pods_get ...'
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling PodServicesApi.pic_v1_pods_get"
      end
      # verify the required parameter 'id_number' is set
      if @api_client.config.client_side_validation && id_number.nil?
        fail ArgumentError, "Missing the required parameter 'id_number' when calling PodServicesApi.pic_v1_pods_get"
      end
      # verify the required parameter 'ref' is set
      if @api_client.config.client_side_validation && ref.nil?
        fail ArgumentError, "Missing the required parameter 'ref' when calling PodServicesApi.pic_v1_pods_get"
      end
      # verify the required parameter 'ref_type' is set
      if @api_client.config.client_side_validation && ref_type.nil?
        fail ArgumentError, "Missing the required parameter 'ref_type' when calling PodServicesApi.pic_v1_pods_get"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && opts[:'pod_type'] && !['CONTENT', 'LINK'].include?(opts[:'pod_type'])
        fail ArgumentError, 'invalid value for "pod_type", must be one of CONTENT, LINK'
      end
      # resource path
      local_var_path = '/pic/v1/pods'
      ...
      query_params[:'podType'] = opts[:'pod_type'] if !opts[:'pod_type'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PodResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PodServicesApi#pic_v1_pods_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
