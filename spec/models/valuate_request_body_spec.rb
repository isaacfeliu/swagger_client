...
# Unit tests for SwaggerClient::ValuateRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValuateRequestBody' do
  before do
    # run before each test
    @instance = SwaggerClient::ValuateRequestBody.new
  end
  ...
  describe 'test an instance of ValuateRequestBody' do
    it 'should create an instance of ValuateRequestBody' do
      expect(@instance).to be_instance_of(SwaggerClient::ValuateRequestBody)
    end
  end
end
