...
# Unit tests for SwaggerClient::ActorShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActorShipment' do
  before do
    # run before each test
    @instance = SwaggerClient::ActorShipment.new
  end
  ...
  describe 'test an instance of ActorShipment' do
    it 'should create an instance of ActorShipment' do
      expect(@instance).to be_instance_of(SwaggerClient::ActorShipment)
    end
  end
