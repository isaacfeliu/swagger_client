...
module SwaggerClient
  class Custom
    attr_accessor :allows_customs

    attr_accessor :shipment_weight

    attr_accessor :shipment_value

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'allows_customs' => :'allowsCustoms',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allowsCustoms')
        self.allows_customs = attributes[:'allowsCustoms']
      end
      ...
      if attributes.has_key?(:'shipmentValue')
        self.shipment_value = attributes[:'shipmentValue']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allows_customs == o.allows_customs &&
          shipment_weight == o.shipment_weight &&
          shipment_value == o.shipment_value
    end
    ...
    def hash
      [allows_customs, shipment_weight, shipment_value].hash
    end
