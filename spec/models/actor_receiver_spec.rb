...
# Unit tests for SwaggerClient::ActorReceiver
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActorReceiver' do
  before do
    # run before each test
    @instance = SwaggerClient::ActorReceiver.new
  end
  ...
  describe 'test an instance of ActorReceiver' do
    it 'should create an instance of ActorReceiver' do
      expect(@instance).to be_instance_of(SwaggerClient::ActorReceiver)
    end
  end
