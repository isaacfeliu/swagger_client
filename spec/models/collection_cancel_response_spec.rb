...
# Unit tests for SwaggerClient::CollectionCancelResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CollectionCancelResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CollectionCancelResponse.new
  end
  ...
  describe 'test an instance of CollectionCancelResponse' do
    it 'should create an instance of CollectionCancelResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CollectionCancelResponse)
    end
  end
