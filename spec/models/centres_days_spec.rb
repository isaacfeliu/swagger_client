...
# Unit tests for SwaggerClient::CentresDays
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CentresDays' do
  before do
    # run before each test
    @instance = SwaggerClient::CentresDays.new
  end
  ...
  describe 'test an instance of CentresDays' do
    it 'should create an instance of CentresDays' do
      expect(@instance).to be_instance_of(SwaggerClient::CentresDays)
    end
  end
