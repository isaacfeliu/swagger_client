...
# Unit tests for SwaggerClient::CashDeliveryValueShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CashDeliveryValueShipment' do
  before do
    # run before each test
    @instance = SwaggerClient::CashDeliveryValueShipment.new
  end
  ...
  describe 'test an instance of CashDeliveryValueShipment' do
    it 'should create an instance of CashDeliveryValueShipment' do
      expect(@instance).to be_instance_of(SwaggerClient::CashDeliveryValueShipment)
    end
  end
  ...
  describe 'test attribute "cash_on_delivery_fee"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
