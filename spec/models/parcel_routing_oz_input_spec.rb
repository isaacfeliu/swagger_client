...
# Unit tests for SwaggerClient::ParcelRoutingOZInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParcelRoutingOZInput' do
  before do
    # run before each test
    @instance = SwaggerClient::ParcelRoutingOZInput.new
  end
  ...
  describe 'test an instance of ParcelRoutingOZInput' do
    it 'should create an instance of ParcelRoutingOZInput' do
      expect(@instance).to be_instance_of(SwaggerClient::ParcelRoutingOZInput)
    end
  end
  ...
  describe 'test attribute "weigth"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
