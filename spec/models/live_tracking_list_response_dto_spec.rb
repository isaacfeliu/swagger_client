...
# Unit tests for SwaggerClient::LiveTrackingListResponseDto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LiveTrackingListResponseDto' do
  before do
    # run before each test
    @instance = SwaggerClient::LiveTrackingListResponseDto.new
  end
  ...
  describe 'test an instance of LiveTrackingListResponseDto' do
    it 'should create an instance of LiveTrackingListResponseDto' do
      expect(@instance).to be_instance_of(SwaggerClient::LiveTrackingListResponseDto)
    end
  end
end
