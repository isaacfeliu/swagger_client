...
# Unit tests for SwaggerClient::AddParcelP
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddParcelP' do
  before do
    # run before each test
    @instance = SwaggerClient::AddParcelP.new
  end
  ...
  describe 'test an instance of AddParcelP' do
    it 'should create an instance of AddParcelP' do
      expect(@instance).to be_instance_of(SwaggerClient::AddParcelP)
    end
  end
  ...
  describe 'test attribute "parcel_reference"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "agd_reference"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
