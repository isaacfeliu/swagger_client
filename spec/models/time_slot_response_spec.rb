...
# Unit tests for SwaggerClient::TimeSlotResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeSlotResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::TimeSlotResponse.new
  end
  ...
  describe 'test an instance of TimeSlotResponse' do
    it 'should create an instance of TimeSlotResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::TimeSlotResponse)
    end
  end
