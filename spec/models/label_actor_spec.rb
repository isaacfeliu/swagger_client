...
# Unit tests for SwaggerClient::LabelActor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelActor' do
  before do
    # run before each test
    @instance = SwaggerClient::LabelActor.new
  end
  ...
  describe 'test an instance of LabelActor' do
    it 'should create an instance of LabelActor' do
      expect(@instance).to be_instance_of(SwaggerClient::LabelActor)
    end
  end
