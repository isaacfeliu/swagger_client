...
# Unit tests for SwaggerClient::ExtendedSituation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExtendedSituation' do
  before do
    # run before each test
    @instance = SwaggerClient::ExtendedSituation.new
  end
  ...
  describe 'test an instance of ExtendedSituation' do
    it 'should create an instance of ExtendedSituation' do
      expect(@instance).to be_instance_of(SwaggerClient::ExtendedSituation)
    end
  end
  ...
  describe 'test attribute "shipment_ref"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "collection_ref"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "situations"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
