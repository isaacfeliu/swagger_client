...
# Unit tests for SwaggerClient::SimplifiedSituationData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SimplifiedSituationData' do
  before do
    # run before each test
    @instance = SwaggerClient::SimplifiedSituationData.new
  end
  ...
  describe 'test an instance of SimplifiedSituationData' do
    it 'should create an instance of SimplifiedSituationData' do
      expect(@instance).to be_instance_of(SwaggerClient::SimplifiedSituationData)
    end
  end
end
