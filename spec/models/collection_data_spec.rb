...
# Unit tests for SwaggerClient::CollectionData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CollectionData' do
  before do
    # run before each test
    @instance = SwaggerClient::CollectionData.new
  end
  ...
  describe 'test an instance of CollectionData' do
    it 'should create an instance of CollectionData' do
      expect(@instance).to be_instance_of(SwaggerClient::CollectionData)
    end
  end
  ...
  describe 'test attribute "f_rec"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
