...
module SwaggerClient
  class ShipmentData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'returnEcbs')
        if (value = attributes[:'returnEcbs']).is_a?(Array)
          self.return_ecbs = value
        end
      end
    end
    ...
    def hash
      [shipment_code, ecbs, parcel_numbers, return_ecbs].hash
    end
