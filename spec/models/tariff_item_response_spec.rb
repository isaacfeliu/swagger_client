...
# Unit tests for SwaggerClient::TariffItemResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TariffItemResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::TariffItemResponse.new
  end
  ...
  describe 'test an instance of TariffItemResponse' do
    it 'should create an instance of TariffItemResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::TariffItemResponse)
    end
  end
