...
# Unit tests for SwaggerClient::CentresResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CentresResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CentresResponse.new
  end
  ...
  describe 'test an instance of CentresResponse' do
    it 'should create an instance of CentresResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CentresResponse)
    end
  end
