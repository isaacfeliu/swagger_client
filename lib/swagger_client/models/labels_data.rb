...
module SwaggerClient
  class LabelsData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'errorsDesc')
        self.errors_desc = attributes[:'errorsDesc']
      end
    ...
    def hash
      [ecb, packs, label, qr, pdf, url, errors_desc, output_platform].hash
    end
