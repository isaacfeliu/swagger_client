...
# Unit tests for SwaggerClient::SimplifiedSituationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SimplifiedSituationResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::SimplifiedSituationResponse.new
  end
  ...
  describe 'test an instance of SimplifiedSituationResponse' do
    it 'should create an instance of SimplifiedSituationResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::SimplifiedSituationResponse)
    end
  end
