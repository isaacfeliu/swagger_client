...
module SwaggerClient
  class ActorAddress
    ...
    def valid?
      ...
      return false if @street_name.to_s.length > 70
      return false if @city_name.nil?
      return false if @city_name.to_s.length > 50
      return false if @postal_code.nil?
      return false if @postal_code.to_s.length > 10
      return false if @country.nil?
      return false if @country.to_s.length > 8
      true
    end
