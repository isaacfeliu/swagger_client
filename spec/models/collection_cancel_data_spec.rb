...
# Unit tests for SwaggerClient::CollectionCancelData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CollectionCancelData' do
  before do
    # run before each test
    @instance = SwaggerClient::CollectionCancelData.new
  end
  ...
  describe 'test an instance of CollectionCancelData' do
    it 'should create an instance of CollectionCancelData' do
      expect(@instance).to be_instance_of(SwaggerClient::CollectionCancelData)
    end
  end
