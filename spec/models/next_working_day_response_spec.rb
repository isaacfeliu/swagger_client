...
# Unit tests for SwaggerClient::NextWorkingDayResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NextWorkingDayResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::NextWorkingDayResponse.new
  end
  ...
  describe 'test an instance of NextWorkingDayResponse' do
    it 'should create an instance of NextWorkingDayResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::NextWorkingDayResponse)
    end
  end
