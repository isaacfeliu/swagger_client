...
module SwaggerClient
  class GenericCreateResponseDto
    attr_accessor :code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'detailedMessage')
        self.detailed_message = attributes[:'detailedMessage']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          code == o.code &&
          message == o.message &&
          detailed_message == o.detailed_message
    end
    ...
    def hash
      [code, message, detailed_message].hash
    end
